...
-   SVD scoring scale locked after slight modifications after consensus
    decision within the assessor group.
...
-   After the first assessment relibility phase, each assessor will have
    a number of subjects allocated for scoring/annotation (see
